...
namespace diffdrive_arduino
{
  ...
  hardware_interface::return_type DiffDriveArduinoHardware::read(const rclcpp::Time & /*time*/, const rclcpp::Duration & /* period */)
  {
    ...
    // comms_.read_encoder_values(wheel_rear_l_.enc, wheel_rear_r_.enc);

    // double delta_seconds = period.seconds();

    // double pos_prev = wheel_rear_l_.pos;
    // wheel_rear_l_.pos = wheel_rear_l_.calc_enc_angle();
    // wheel_rear_l_.vel = (wheel_rear_l_.pos - pos_prev) / delta_seconds;

    // pos_prev = wheel_rear_r_.pos;
    // wheel_rear_r_.pos = wheel_rear_r_.calc_enc_angle();
    // wheel_rear_r_.vel = (wheel_rear_r_.pos - pos_prev) / delta_seconds;
  ...
  hardware_interface::return_type diffdrive_arduino ::DiffDriveArduinoHardware::write(const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
  {
    ...
    // int motor_l_counts_per_loop = wheel_rear_l_.cmd / wheel_rear_l_.rads_per_count / cfg_.loop_rate;
    // int motor_r_counts_per_loop = wheel_rear_r_.cmd / wheel_rear_r_.rads_per_count / cfg_.loop_rate;
